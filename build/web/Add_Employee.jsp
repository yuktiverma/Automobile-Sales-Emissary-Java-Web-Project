...
<body>
    ...
    <center>
        <form name="addemp" id="addempform" action="addemployee.do" method="get">
  ...
  <tr>
    ...
    <td colspan="7" valign="top"><p align="center" class="style1">Enter The Details Of Employee  </p></td>
    <td width="40">&nbsp;</td>
  </tr>
...
<tr>
  ...
  <tr>
	...
	<table border="1"><tr><td>
		...
		<tr>
		 <td   height="20"valign="top"><div align="center">Mobile</div></td>
    	 <td >&nbsp;</td>
    	<td  valign="top"><input type="text" name="t14"  class="txtfld"/></td>
    	</tr>
		<tr>
		 <td height="15" >&nbsp;</td>
    	 <td >&nbsp;</td>
  ...
  <tr>
    ...
    <td >&nbsp;</td>
    <td valign="top"><input type="text" name="t15"  class="txtfld"/></td>
    <td >&nbsp;</td>
  ...
  <tr>
    ...
    <td >&nbsp;</td>
    <td valign="top" ><input type="text" name="t17" id="addcal1" class="Datefld"  /></td>
    <td ><a href="javascript:showCal('empadd')"><img src="Images/calendar.jpg"/></a></td>
    <td  valign="top"><div align="center">Date Of leaving </div></td>
    <td >&nbsp;</td>
    <td  valign="top"><input type="text" name="t18" id="addcal2"  class="Datefld" /></td>
    <td><a href="javascript:showCal('empadd1')"><img src="Images/calendar.jpg"/></a></td>
  </tr>
  <tr>
  <td height="15">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <td height="15">&nbsp;</td>
    ...
    <td>&nbsp;</td>
     ...
     <script type="text/javascript" language="javascript">
              var o= new Validator("addempform");
