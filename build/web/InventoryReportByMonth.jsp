...
<body>
    <br> <br>
    <center>
        <form name="inventoryreportbymonth" action=" InventoryReportByMonth.do">
...
<tr>
    <td height="20">&nbsp;</td>
    <td valign="top" ><div align="center">Month <span class="style2">*</span> </div></td>
    <td>&nbsp;</td>
   <s:query dataSource="${ds}" sql="select month(Inv_Allocation_Date) as a from branch_allocation_master" var="rs"></s:query>

         <td valign="top"><select id="branch" name="selectmonth" class="combo">
            <option value="select">select</option>
             <c:forEach items="${rs.rows}" var="data">
                <option value="${data.a}" >${data.a}</option>
            </c:forEach>
