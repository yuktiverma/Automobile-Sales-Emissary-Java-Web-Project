    ...
    <center>
      ...
      <td>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td valign="top"><label>
                            <select name="ordid" id="select1" class="combo">
      ...
      <td>&nbsp;</td>
      <td valign="top">
	  <input type="text" name="empid" class="txtfld" id="select3" value="${data.Model_Id}"/>
      ...
      <td>&nbsp;</td>
      <td valign="top"><label>
        <input type="text" name="colid" id="select6" class="combo" value="${data.Color_Id}"/>
        </label></td>
      <td>&nbsp;</td>
    </tr>
                  <tr>
