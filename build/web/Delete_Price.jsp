...
<html>
    <head>
        ...
        <title>Delete Price Details</title>
        <style type="text/css">
    ...
    <body>
        ...
        <center>
            <form  action="deletePrice.do" method="post">
            <table border="1"><tr><td>
                        <table width="480" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="70" height="50">&nbsp;</td>
                                <td colspan="3" valign="top" bgcolor="lightblue"><div align="center" class="style1">Delete Price Details</div></td>
                                <td width="70">&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td valign="top">
                                    <input type="text" name="t1" class="txtfld" readonly="" value="${param['Price_Id']}"/>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td valign="top">
                                    <input type="text" name="t2" class="txtfld" readonly="" value="${data.Model_Id}" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td valign="top"><input type="text" name="t3" class="txtfld" readonly="" value="${data.Price}" /></td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td >&nbsp;</td>
                                <td valign="top" ><input type="text" name="t4" class="txtfld" readonly="" value="${data.Date_From}"/></td>
                            </tr>
