...
<html>
    <head>
        ...
        <title>Show Model Details</title>
    </head>
        ...
        <center>
            <form action="AfterLogin.do" method="post">
                            ...
                            <tr>
                                ...
                                <td colspan="3" valign="top" bgcolor="lightblue"><div align="center" class="style1">Show Model Details</div></td>
                                <td width="70">&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="150"valign="top">
                                    <input type="text" name="t5" class="txtfld" readonly="" value="${param['Model_Id']}" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td valign="top"><input type="text" name="t5" class="txtfld" readonly="" value="${data.Model_Name}"/></td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td valign="top">
                                    <input type="text" name="t5" class="txtfld" readonly="" value="${data.Engine}"/>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                <td height="20">&nbsp;</td>
                                <td valign="top"><div align="center"class="whfont">Dealer Margin</div></td>
                                <td >&nbsp;</td>
                                <td valign="top">
                                    <input type="text" name="t5" class="txtfld" readonly="" value="${data.Dealer_Margin}"/>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td >&nbsp;</td>
                                <td valign="top">
                                    <input type="text" name="t5" class="txtfld" readonly="" value="${data.Power}"/>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td >&nbsp;</td>
                                <td valign="top">
                                    <input type="text" name="t5" class="txtfld" readonly="" value="${data.Mileage}"/>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td >&nbsp;</td>
                                <td valign="top">
                                    <input type="text" name="t5" class="txtfld" readonly="" value="${data.Engine_Type}"/>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
