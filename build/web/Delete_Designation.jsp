...
<body>
    ...
    <center>
        <form name="delete_desig" action="deletedesig.do">
...
<table width="540" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td valign="top"><input type="text" name="t4"  class="txtfld" value="${param['Desig_Id']}" readonly/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="10">&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td valign="top"><input type="text" name="t1"  class="txtfld"  value=${data.Desig_Name} readonly/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="10">&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td valign="top"><input type="text" name="t2"  class="txtfld" readonly  value=${data.AccessTo_All_Branches}  /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="10">&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td valign="top"><input type="text" name="t3"  class="txtfld" readonly value=${data.Access_To_All_Teams}  /> </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="10">&nbsp;</td>
  ...
  <tr>
    ...
    <td valign="top"><div align="center">
      <input type="submit" name="Submit2" value="Delete"   class="buttonSubmit" />
    </div></td>
    <td>&nbsp;</td>
  </tr>
