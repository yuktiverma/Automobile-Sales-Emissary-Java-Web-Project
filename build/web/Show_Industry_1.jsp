<%-- 
    Document   : Show_Industry_1
    Created on : Apr 27, 2013, 8:16:40 PM
    Author     : Disha
--%>
...
<s:query dataSource="${ds}" sql="select * from industry_master where Industry_Name='${param['cid']}'" var="rs"></s:query>
...
<body><br><br><br>
  ...
  <tr>
    ...
    <td colspan="7" valign="top" bgcolor=lightblue>
