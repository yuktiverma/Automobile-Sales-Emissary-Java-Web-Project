...
<body>
    ...
    <center>
        <form name="addteam" action="addteam.do" method="get">
...
<table width="480" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="3" valign="top" ><div align="center" class="style1">Enter Team Details </div></td>
    <td width="70">&nbsp;</td>
  </tr>

  <tr>
    <td height="20">&nbsp;</td>
    <td valign="top" ><div align="left" class="whfont">Branch Name </div></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td valign="top"><div  class="whfont">Team Type& Model <span class="style2">*</span>  </div></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td valign="top"><div class="whfont">Team Manager Id <span class="style2">*</span>  </div></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td valign="top"><div  class="whfont">Team Leader Id <span class="style2">*</span>  </div></td>
    <td>&nbsp;</td>
    <s:query dataSource="${ds}" sql="select * from employee_master" var="rs"></s:query>
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td valign="top"><div  class="whfont">Team Name <span class="style2">*</span> </div></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td valign="top"><div class="whfont">Status Id  </div></td>
    <td>&nbsp;</td>
