...
<s:query dataSource="${ds}" sql="select Prospect_Id,Prospect_Fname,Prospect_Lname,P_Phone1,P_Email,Model_To_Buy,P_City,P_StreetAddress from prospect_master where Prospect_Id='${param['pid']}'" var="rs"></s:query>
...
<script type="text/javascript"></script>
    ...
    <center>
        <form action="delprospect.do" name="delpros"id="delprosform">
