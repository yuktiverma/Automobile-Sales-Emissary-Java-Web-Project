...
<script type="text/javascript" language="javascript">
    ...
    function getScheme()
    {
        ...
        xhro.open("get","Showscheme_1.jsp?sid="+v+"",true);
        xhro.send();
    }
    function myfun()
    {
...
<body>
    ...
    <center>
        ...
        <form name="showscheme">

            <table style="border:0px solid #333;"  cellpadding="0" cellspacing="0" width="480">
                  <!--DWLayoutTable-->

                  <tbody><tr>
                    <td width="70" height="40">&nbsp;</td>
                    <td colspan="3" valign="top" ><div class="style1" align="center">SHOW SCHEME</div></td>
      <td width="70">&nbsp;</td>
    </tr>
                    <tr>
                      <td height="22">&nbsp;</td>
                      ...
                      <td valign="top"><label>
                              ...
                              <select name="schmid" class="combo" id="schmid" onchange="getScheme()">
                            <option></option>
      ...
      <td>&nbsp;</td>
                      <td valign="top"><input type="text"  name="modid" class="txtfld"></td>
      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="20">&nbsp;</td>
      ...
      <td></td>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td valign="top"><label>
                              <input type="text" name="textfield" class="txtfld">
                      </label></td>
                      <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td valign="top"><label>
                              <input type="text" name="textfield2" class="txtfld">
                      </label></td>
                      <td></td>
                    </tr>
                    <tr>
...
<script type="text/javascript" language="javascript">
        var o= new Validator("showscheme");
