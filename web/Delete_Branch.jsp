...
<%-- 
    Document   : Delete_Branch
    Created on : Apr 11, 2013, 4:56:03 PM
    Author     : Yukti
--%>
...
<body><center>
        ...
        <form name="deletebranch" action="deletebranch.do">
...
<table width="480" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td valign="top"><input type="text" name="t11" readonly class="txtfld" value="${param['Branch_Id']}" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td valign="top"><div align="center">
      <input type="submit" name="Submit" value="Delete"  class="buttonSubmit" />
    </div></td>
    <td>&nbsp;</td>
  </tr>
