...
<script  type="text/javascript" language="javascript">
    ...
    function getOrder()
    {
        ...
        xhro.open("get","Showorder_1.jsp?oid="+o+"",true);
        xhro.send();
        ...
        function myfun()
    {
        ...
        {
            document.getElementById("showord").innerHTML=xhro.responseText;
        }
    }
...
<body>
    ...
    <center>
        ...
        <div id="showord">
            <form name="showorder" action="">


            <table width="480" style="border:0px solid#333" cellpadding="0" cellspacing="0">
                  <!--DWLayoutTable-->
                  <tr>
                    <td width="70" height="40">&nbsp;</td>
      <td colspan="3" valign="top" ><div align="center" class="style1">SHOW ORDER DETAILS </div></td>
      <td width="70">&nbsp;</td>
    </tr>
                  <tr>
                    <td height="20">&nbsp;</td>
      ...
      <td>&nbsp;</td>
             ...
             <select name="ordid" id="order" class="combo" onchange="getOrder()">
                                <option></option>
      ...
      <td>&nbsp;</td>
      <td valign="top"><label>
        <input type="text" name="colid" id="select6" class="combo"/>
        </label></td>
      <td>&nbsp;</td>
    </tr>
                  <tr>
