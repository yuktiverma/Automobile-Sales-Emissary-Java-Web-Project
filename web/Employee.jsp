...
<div style="width: 648px; height: 350px;">
    <center>
        <form action="employeeaction.do" name="Employee">
...
<table width="480" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="3" valign="top" bgcolor="lightblue"><div align="center" class="style1" >Employee</div>
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td valign="top"><div align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Branch Id/Location<span class="style2">*</span>  </div></td>
    <td>&nbsp;</td>
    <td valign="top"><select name="t1" class="combo">
            <option value="select">--select--</option>
            <c:forEach items="${r.rows}" var="row">
            <option value="select">${row.Branch_Id}/ ${row.Branch_City}</option>
    </c:forEach>
     </select>
    </td>
    <td>&nbsp;</td>
 ...
 <tr>
    <td height="20">&nbsp;</td>
    <td valign="top"><div align="center">&nbsp;&nbsp;Employee Type <span class="style2">*</span>  </div></td>
    <td>&nbsp;</td>
