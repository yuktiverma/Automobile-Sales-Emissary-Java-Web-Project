<%--
    Document   : Inventory_Report_At_Branch_level
    Created on : Apr 16, 2013, 12:05:10 PM
    Author     : Ankit
--%>
...
<title>Inventory Report Of Sold Overall </title>
<style type="text/css">
<!--
.style1 {
	font-size: 20px;
...
<script type="text/javascript" language="javascript">
    ...
    function getdet()
    {
      ...
      xhro3.open("get","detail_2.jsp?&mid="+v2+"&cid="+v3+"",true);
        xhro3.send();
    }
    function myfun3()
    {
...
<body>
        <center>
        <form name="inventoryreportofsoldoverall">
...
<table width="480" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="3" valign="top" bgcolor="lightblue"><div align="center" class="style1">Inventory Report : <br> Of Sold Overall </div></td>
    <td width="70">&nbsp;</td>
  </tr>
   <tr>
    <td height="20">&nbsp;</td>
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td valign="top"><div align="center">Total Number Of Branches </div></td>
    <td>&nbsp;</td>
    <td valign="top"><input type="text" name="t1"  class="txtfld" value="${param['b']}" readonly/></td>
    <td>&nbsp;</td>
  </tr>
   <tr>
    <td height="20">&nbsp;</td>
   ...
   <tr>
    ...
    <td>&nbsp;</td>
    <td valign="top"><input type="text" name="t2"  class="txtfld" value="${param['t']}" readonly/></td>
    <td>&nbsp;</td>
  </tr>
   <tr>
    <td height="20">&nbsp;</td>
 ...
 <tr>
    ...
    <td>&nbsp;</td>
    <td valign="top"><input type="text" name="t3"  class="txtfld"  value="${param['s']}" readonly/></td>
    <td>&nbsp;</td>
  </tr>
   <tr>
    <td height="20">&nbsp;</td>
