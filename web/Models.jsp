...
<div style="width: 648px; height: 350px;">
    <center>
        <form action="modelaction.do" name="Models">
...
<table width="480" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td valign="top"><div align="center" class="whfont">Branch Id/Name<span class="style2">*</span>  </div></td>
    <td>&nbsp;</td>
    <td valign="top">
        <select name="t1" class="combo">
            <option value="select">--select--</option>
        <c:forEach items="${r.rows}" var="row">
            <option value="select">${row.Branch_Id}/ ${row.Branch_Name}</option>
    </c:forEach>
            </select>
    </td>
    <td>&nbsp;</td>
