...
<table ><s:query dataSource="${ds}" sql="select sum(Total_Quantity_Allocated) as a from branch_allocation_master where Inventory_Id=${param['invid']} && Branch_Id=${param['bid']} group by Inventory_Id" var="rs1"></s:query>
