...
<script type="text/javascript" language="javascript">
    ...
    function getdetails()
    {
      ...
      xhro1.open("get","getinv_details_1.jsp?invid="+v+"&bid="+v1+"",true);
        xhro1.send();
    }
    function myfun1()
    {
...
<script type="text/javascript" language="javascript">
    ...
    function getdet()
    {
      ...
      xhro3.open("get","detail_1.jsp?invid="+v+"&bid="+v1+"&mid="+v2+"&cid="+v3+"",true);
        xhro3.send();
    }
    function myfun3()
    {
...
<body>
    <br> <br>
    <center>
        <form name="inventoryreportofstockofbranch">
...
<table width="460" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="3" valign="top" ><div align="center" class="style1">Inventory Report Of : <br> Stock In Branch  </div></td>
    <td width="50">&nbsp;</td>
  </tr>
   <tr>
    <td height="20">&nbsp;</td>
 ...
 <tr>
    ...
    <td height="20" valign="top"><div align="center">Total Number Of Quantities In Hand  </div></td>
    <td>&nbsp;</td>
...
<td>&nbsp;</td>
 ...
 <tr>
    ...
    <td height="20" valign="top"><div align="center">Total  Quantities Model Of Sold  </div></td>
    <td>&nbsp;</td>
    <td valign="top"><input type="text" name="t2"  class="txtfld" readonly/></td>
   ...
   <tr>
       <td height="20" valign="top"><div align="center">Total Quantities Model Of Hand   </div></td>
    <td>&nbsp;</td>
