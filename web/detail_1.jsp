...
<s:query dataSource="${ds}" sql="select sum(Total_Quantity_Allocated) as a from branch_allocation_master where Inventory_Id=${param['invid']} && Branch_Id=${param['bid']} && Model_Id=${param['mid']} && Color_Id=${param['cid']} group by Color_Id" var="rs1"></s:query>
<s:query dataSource="${ds}" sql="select sum(Model_Sold) as b from branch_allocation_master where Inventory_Id=${param['invid']} && Branch_Id=${param['bid']} && Model_Id=${param['mid']} && Color_Id=${param['cid']} group by Color_Id" var="rs2"></s:query>
<table >
    <tr>
    <td height="20">&nbsp;</td>
    <td>&nbsp;</td>
 ...
 <tr>
  ...
  <tr>
       <td height="20" valign="top"><div align="center"> Total Number Model In Hand   </div></td>
    <td width="30"></td>
    <td valign="top"width="150" >
        <c:forEach items="${rs2.rows}" var="data2">
