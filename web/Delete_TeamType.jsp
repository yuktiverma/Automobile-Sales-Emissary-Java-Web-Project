...
<body>
    ...
    <center>
        <form name="addteambm" action="deleteteamtype.do">
...
<table width="480" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="3" valign="top" bgcolor="lightblue"><div align="center" class="style1">Team Type Details </div></td>
    <td width="70">&nbsp;</td>
  </tr>
  <tr>
    <td height="20">&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
       ...
       <td valign="top"><div align="center">
            <input type="submit" value="Delete" class="buttonSubmit" /></div></td>
    <td>&nbsp;</td>
  </tr>
