...
<s:query dataSource="${ds}" sql="select Prospect_Id,Model_To_Buy,Color_To_Buy,Status_Id,FollowUp_Date from prospect_master where Prospect_Id='${param['pid']}'" var="rs"></s:query>
...
<body>
    <center>
        <form action="addcase.do" method="get" name="addcase" id="addcaseform">
  ...
  <tr>
    ...
    <td colspan="3" valign="top" >
    	...
    	<td width="140" valign="top"><select name="select1" class="combo">
                <option value="${data.Model_To_Buy}" >${data.Model_To_Buy}</option>
    	...
    	<td  valign="top"><select name="select2" class="combo">
    	        <option value="${data.Color_To_Buy}" >${data.Color_To_Buy}</option>
                    </select>   </td>
    	</tr>
...
<tr>
    ...
    <td width="30">&nbsp;</td>
    	<td width="140" valign="top"><select name="select4" class="combo">
                ...
                <option value="${data.Status_Id}" >${data.Status_Id}</option>
 ...
 <tr>
    	 ...
    	 <td >&nbsp;</td>
         <td  valign="top" ><input type="text" name="t2" id="addcal3" class="Datefld"  value="${data.FollowUp_Date}" /></td>
    <td></td>
    	</tr>
