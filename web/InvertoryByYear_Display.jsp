<%--
    Document   : Sale_Branch_Wize_Disp
    Created on : May 1, 2013, 11:25:05 PM
    Author     : abc
--%>
...
<html>
    ...
    <body>
        ...
        <d:table name="sessionScope.InventoryByYear_Bean.al" export="true" style="border:1px solid #ccc;background-color:#666666;">
