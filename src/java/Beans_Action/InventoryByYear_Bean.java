 ...
 * @author Yukti
 */
public class InventoryByYear_Bean extends org.apache.struts.action.ActionForm {
...
private  int  selectyear;
 ...
 private ArrayList<InventoryByYear> al;
   ...
   ResultSet rs=st.executeQuery("select * from branch_allocation_master where year(inv_allocation_date)="+selectyear+" ");
 while(rs.next())
{
